    ...
    return (
        ...
        <>
            ...
            { FechasPresentables.map((FechaPresentable, Indice, Array) => {
                ...
                const Boolean = [0,7,14,21,28,35].includes(Indice)
                ...
                return (
                    ...
                    style={{ 
                        ...
                        color: (Antecede || Precede) ? "#BCBBD9" : "initial" , 
                        
                        backgroundColor: Seleccionado ? "#ff47a1" : "initial",

                        borderRadius: Indice === 35 ? "0px 0px 0px 4px" : Indice === 41 ? "0px 0px 4px 0px" : "none",

                        borderLeft: Boolean ? "solid 1px rgb(177, 177, 177)" : "none"
