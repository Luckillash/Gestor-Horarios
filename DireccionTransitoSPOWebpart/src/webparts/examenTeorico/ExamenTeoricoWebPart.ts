...
import * as strings from 'ExamenTeoricoWebPartStrings';
...
export interface IExamenTeoricoWebPartProps {

  description: string;

}

export default class ExamenTeoricoWebPart extends BaseClientSideWebPart<IExamenTeoricoWebPartProps> {
